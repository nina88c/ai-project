...
function generateName(event) {
   ...
   let context = "NEVER give affirmations.You are a baby name generator.You are a baby name generator! You give similar baby names like the user inputs in a BULLET POINTED LIST.";
